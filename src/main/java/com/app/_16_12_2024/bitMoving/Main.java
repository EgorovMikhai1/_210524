...
//например однобитные изображения, когда на 1.txt пиксель отводиться 1 бит
...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * 1 ГГц = 10⁹ Гц — миллиард операций в секунду.
         * Побитовая операция - это 1 такт
         */
        ...
        printBinary(b1);
        printBinary(b2);
        printBinary(b1 | b2); // хотя бы у одного есть 1.txt
        ...
        System.out.println((i & 0b00001000) > 0 ? "1.txt" : "0");
        System.out.println("*************************");
    ...
    public static class BitArray {
        ...
        public void set (int index, int value) {
            ...
            //если значение больше 0 то надо установить бит 1.txt
            if (value > 0) {
